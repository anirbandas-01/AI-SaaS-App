        ...
        <div className='text-gray-500/80 pt-8 px-6 md:px-16 lg:px-24 xl:px-32 mt-20'>
            <div className='flex flex-wrap justify-between gap-12 md:gap-6'>
                <div className='max-w-80'>
                    ...
                    <p className='text-sm'>
                      Experience the power of AI with QuickAi <br/>Transform your content creation with of AI with our suite of premium AI tools. write articles, generate images, and enhance your workflow.             
                    </p>
            ...
            <div className='flex flex-col md:flex-row gap-2 items-center justify-between py-5'>
                <p>© {new Date().getFullYear()} <a href="https://prebuiltui.com">Airban</a>. All rights reserved.</p>
